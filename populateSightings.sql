...
-- DELETE FROM SuperheroSightings.Addresses WHERE AddressId >= 0;
-- 
-- INSERT INTO SuperheroSightings.Addresses (AddressId, StreetAddress, City, State, Zip, Latitude, Longitude)
...
DELETE FROM SuperheroSightings.Locations WHERE LocationId >= 0;

INSERT INTO SuperheroSightings.Locations (LocationId, Landmark, Description, StreetAddress, City, State, Zip, Latitude, Longitude)
...
DELETE FROM SuperheroSightings.Organizations WHERE OrganizationId >= 0;

INSERT INTO SuperheroSightings.Organizations (OrganizationId, Name, Description, LocationId)
...
DELETE FROM SuperheroSightings.Sightings WHERE SightingId >= 0;

INSERT INTO SuperheroSightings.Sightings (SightingId, LocationId, SightingDate)
...
DELETE FROM SuperheroSightings.HeroesAndVillains WHERE SuperId >= 0;

INSERT INTO SuperheroSightings.HeroesAndVillains (SuperId, SuperName, Alias, Cover, isVillain)
...
DELETE FROM SuperheroSightings.Superpowers WHERE SuperpowerId >= 0;

INSERT INTO SuperheroSightings.Superpowers (SuperpowerId, Superpower)
...
DELETE FROM SuperheroSightings.SupersSuperpowers WHERE SuperId >= 0;
DELETE FROM SuperheroSightings.SupersSuperpowers WHERE SuperpowerId >= 0;

INSERT INTO SuperheroSightings.SupersSuperpowers (SuperId, SuperpowerId)
VALUES (1, 1), (1, 2), (1, 6),
		(2, 1), (2, 5),
		(3, 1), (3, 3), (3, 4),
        (4, 1), (4, 2),
...
DELETE FROM SuperheroSightings.OrganizationsSupers WHERE OrganizationId >= 0;
DELETE FROM SuperheroSightings.OrganizationsSupers WHERE SuperId >= 0;

INSERT INTO SuperheroSightings.OrganizationsSupers (OrganizationId, SuperId)
VALUES (1, 1), (1, 3),
		(2, 2), (2, 4), (2, 5);
...
DELETE FROM SuperheroSightings.SupersSightings WHERE SuperId >= 0;
DELETE FROM SuperheroSightings.SupersSightings WHERE SightingId >= 0;


INSERT INTO SuperheroSightings.SupersSightings (SuperId, SightingId)
